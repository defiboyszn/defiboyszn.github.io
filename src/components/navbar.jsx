...
const Navbar = () => {
  return (
    <>
      <main className="">
        <header
          className={`fixed z-[9999999999] top-0 md:relative !bg-[#1B0A4F] pb-3  w-full scroll:bg-black pt-[20px] px-[32px] md:py-[30px] lg:px-[80px]`}
        >
          <nav className={`flex items-center justify-between`}>
            ...
            <div className="text-[#FFFFFF99] hover:text-white transition-all duration-300">
              <a
                href="https://www.github.com/defiboyszn"
                target="_blank"
                rel="noreferrer"
              >
