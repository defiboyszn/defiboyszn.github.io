          ...
          <div className="mt-[31px] grid grid-cols-1 gap-y-[18.67px] md:grid-cols-2 md:gap-x-3 lg:mt-[36px] lg:gap-[20px]">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className={`bg-gradient-to-${index % 2 === 0 ? 'r' : 'l'} max-w-[369px] lg:max-w-[252px] to-[#4E11C9] from-[#4E11C9]/20 ${index % 2 === 0 ? 'pr-0.5 pt-0.5' : 'pb-0.5 pl-0.5'}`}
              >
                <div className={`bg-[#6213F1] px-[20px] py-[23px] lg:h-fit lg:max-w-full lg:w-[250px] lg:px-[32px] lg:py-[25px]`}>
