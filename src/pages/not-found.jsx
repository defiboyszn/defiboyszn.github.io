  ...
  return (
    <>
      ...
      <section className="overflow-hidden mx-auto relative min-h-[100vh]">
        ...
        <div
          className={`mt-[340px] md:mt-[250px] lg:mt-[400px] text-center mx-auto mb-10`}
        >
          ...
          >Why should i show the page you requested ? It's for insiders only.{" "}
          </p>
          ...
          >
            <motion.button
              ...
              className={`bg-[#6313F1] px-[22.8px] py-[14.85px] text-[14.5px] font-medium font-clash`}
            >
              Teleport Home Now
            </motion.button>
          </Link>
